...
public class TextPane extends Region {
    ...
    public TextPane(Stage stage, String syntax, String initText) {
        ...
        vScroll.visibleProperty().bind(screenBuffer.screenRowSizeProperty().lessThan(screenBuffer.totalLinesProperty()));
    ...
    private void initScreenRowSize(double height) {
        screenBuffer.setupScreenRowSize(Math.max((int) Math.floor(height / lineHeight), 1));
    }
